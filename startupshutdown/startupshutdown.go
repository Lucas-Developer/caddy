...
func Startup(c *caddy.Controller) error {
	...
	fmt.Println("NOTICE: Startup directives will be removed in a later version. Please migrate to 'on startup'")
...
func Shutdown(c *caddy.Controller) error {
	...
	fmt.Println("NOTICE: Shutdown directives will be removed in a later version. Please migrate to 'on shutdown'")
